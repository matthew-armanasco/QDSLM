...
Public Class NKTPDLL
    ...
    '       It is not necessary to open the port, create the device or register before using this function, since it will do a dedicated read.
    '
    ' extrn "C" NKTPDLL_EXPORT DeviceResultTypes deviceGetTypeV2(const char *portname, const unsigned char devId, unsigned short *devType);
    <DllImport("NKTPDLL.dll", EntryPoint:="deviceGetTypeV2", CallingConvention:=CallingConvention.Cdecl, CharSet:=CharSet.Ansi)> _
    Public Shared Function deviceGetTypeV2(<MarshalAs(UnmanagedType.LPStr)> ByVal portname As String, ByVal devId As Byte, ByRef devType As Short) As DeviceResultTypes
    End Function
    ...
    '       It is not necessary to open the port, create the device or register before using this function, since it will do a dedicated read.
    ' extrn "C" NKTPDLL_EXPORT DeviceResultTypes deviceGetSysType(const char *portname, const unsigned char devId, unsigned char *sysType);
    <DllImport("NKTPDLL.dll", EntryPoint:="deviceGetSysType", CallingConvention:=CallingConvention.Cdecl, CharSet:=CharSet.Ansi)> _
    Public Shared Function deviceGetSysType(<MarshalAs(UnmanagedType.LPStr)> ByVal portname As String, ByVal devId As Byte, ByRef sysType As Byte) As DeviceResultTypes
    End Function
    ...
    <DllImport("NKTPDLL.dll", EntryPoint:="deviceGetAllTypesV2", CallingConvention:=CallingConvention.Cdecl, CharSet:=CharSet.Ansi)> _
    Public Shared Function deviceGetAllTypesV2(<MarshalAs(UnmanagedType.LPStr)> ByVal portname As String, <MarshalAs(UnmanagedType.LPArray, SizeParamIndex:=2)> ByRef types As Short(), ByRef maxTypes As Byte) As DeviceResultTypes
    End Function
    ...
    Public Delegate Sub PortStatusCallbackFuncPtr(<MarshalAs(UnmanagedType.LPStr)> ByVal portname As String, ByVal status As PortStatusTypes, ByVal curScanAdr As Byte, ByVal maxScanAdr As Byte, ByVal foundType As Short)
