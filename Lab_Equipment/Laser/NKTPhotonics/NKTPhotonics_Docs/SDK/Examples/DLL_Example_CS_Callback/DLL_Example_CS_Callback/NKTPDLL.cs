...
namespace NKTP
{
    public class NKTPDLL
    {
        ...
        */
        ...
        [DllImport("NKTPDLL.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern DeviceResultTypes deviceGetTypeV2([MarshalAs(UnmanagedType.LPStr)] String portname, byte devId, ref short devType);
        ...
        [DllImport("NKTPDLL.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern DeviceResultTypes deviceGetSysType([MarshalAs(UnmanagedType.LPStr)] String portname, byte devId, ref byte sysType);
        ...
        */
        ...
        [DllImport("NKTPDLL.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern DeviceResultTypes deviceGetAllTypesV2([MarshalAs(UnmanagedType.LPStr)] String portname, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] short[] types, ref byte maxTypes);
        ...
        */
        ...
        public delegate void PortStatusCallbackFuncPtr([MarshalAs(UnmanagedType.LPStr)]String portname, PortStatusTypes status, byte curScanAdr, byte maxScanAdr, short foundType);
